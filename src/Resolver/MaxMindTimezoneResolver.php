...
final readonly class MaxMindTimezoneResolver implements TimezoneResolverInterface
{
    ...
    {
        // Union of Symfony's private-subnet list and networks PHP's
        // reserved-range filter does not consistently reject. The explicit
        // list must stay self-sufficient: PRIVATE_SUBNETS differs between
        // Symfony versions (v6.4.0 lacks Teredo; 7.x dropped documentation
        // and benchmarking ranges), so the union may only ever widen it.
