...
final readonly class MaxMindTimezoneResolver implements TimezoneResolverInterface
{
    ...
    {
        // PHP's reserved-range filter does not consistently reject multicast
        // and documentation networks across supported PHP releases.
        return [
            '0.0.0.0/8', '100.64.0.0/10', '192.0.0.0/24',
            '192.0.2.0/24', '198.18.0.0/15', '198.51.100.0/24',
            '203.0.113.0/24', '224.0.0.0/4', '240.0.0.0/4',
            '::/128', '::ffff:0:0/96', '64:ff9b:1::/48', '100::/64',
